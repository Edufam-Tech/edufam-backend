-- Migration: Create refresh_tokens table for JWT authentication (Simple Version)
-- Date: 2025-01-15
...
BEGIN
    ...
    -- Log cleanup activity (only if audit_logs table exists)
    BEGIN
...
BEGIN
    ...
    -- Log revocation activity (only if audit_logs table exists)
    BEGIN
        INSERT INTO audit_logs (
            table_name, 
            operation, 
