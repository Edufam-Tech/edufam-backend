...
async function runMigration() {
  console.log('🚀 Starting Missing Student Tables Migration...');
  
  try {
    // Read the migration SQL file
    const migrationPath = path.join(__dirname, 'add-missing-student-tables.sql');
    const migrationSQL = fs.readFileSync(migrationPath, 'utf8');
    
    console.log('📋 Executing missing student tables migration...');
    ...
    console.log('✅ Missing Student Tables Migration completed successfully!');
    ...
    console.log('🎉 Missing Student Tables Migration verification completed!');
